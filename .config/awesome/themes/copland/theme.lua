...
--]]	
    ...
    local unfocus = gears.surface.load_uncached(theme.dir .. "/icons/unfocus_icon.png")
    local unfocus_icon = gears.color.recolor_image(unfocus, "#C2CFDB")
    local empty = gears.surface.load_uncached(theme.dir .. "/icons/empty_icon.png")
    local empty_icon = gears.color.recolor_image(empty, "#4C6070")
    local focus = gears.surface.load_uncached(theme.dir .. "/icons/focus_icon.png")
